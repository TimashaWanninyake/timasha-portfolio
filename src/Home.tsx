...
import myImage from "../public/Timasha.jpeg"
        ...
        <div className="pt-8 md:pt-16 lg:pt-32 pl-4 md:pl-6 lg:pl-15 bg-[#ffffff] text-[#343434] min-h-screen pb-8 md:pb-16">
          <div className="flex justify-center items-center flex-col lg:flex-row px-4 md:px-6">
            <motion.div
              ...
              <p className="font-inter text-sm md:text-lg lg:text-lg xl:text-lg font-medium mb-2 ml-0.5">Hi There,</p>
              <p className="font-inter text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-black mb-2">
                I am T<span className="text-[#CC2525]">i</span>masha
              </p>
              <p className="font-inter text-base md:text-xl lg:text-2xl xl:text-3xl font-medium mb-4 leading-tight">
                specializing in full-stack <br className="hidden lg:block"></br>system architecture
              </p>
              <p className="font-inter text-sm md:text-base lg:text-base xl:text-lg font-regular mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-5">
                <a href="#Projects" className="py-3 px-6 md:px-6 lg:px-7 bg-gradient-to-r from-[#d60505] to-[#FF6347] text-white text-sm md:text-base lg:text-lg xl:text-lg rounded-lg hover:shadow-lg transition-shadow">
                  see my work
                </a>
                <a
                  href={cv}
                  download="Timasha Wanninayaka.pdf"
                  className="flex items-center py-3 px-5 md:px-5 lg:px-6 text-[#ce4646] text-sm md:text-base lg:text-lg xl:text-lg rounded-lg hover:bg-gray-50 transition-colors"
                >
