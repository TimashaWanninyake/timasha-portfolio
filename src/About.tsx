    ...
    <div className="flex bg-[#343434]">
      <div className="flex-1 pl-13 flex">
        ...
        <div className="flex-1 mt-15 mb-18 text-[#e7e7e7e4] font-inter font-normal -ml-35 mr-24">
          <h1 className="text-[32px]">Full-Stack <span className="bg-gradient-to-r from-[#d60505] to-[#FF6347] bg-clip-text text-transparent">Developer</span> | UI/UX Explorer | <span className="bg-gradient-to-r from-[#d60505] to-[#FF6347] bg-clip-text text-transparent">Data Science</span> Enthusiast </h1><br />
          ...
          <h3 className="text-[32px] bg-gradient-to-r from-[#d60505] to-[#FF6347] bg-clip-text text-transparent mb-5">Tech I familiar with,</h3>
